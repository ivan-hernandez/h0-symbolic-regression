...
2 rounds, none fatal).  DESI DR2 (arXiv:2503.14738) confirms the DR1 result with
...
but never a \emph{fatal flaw}.  The core result --- $H_0=68.0\pm0.8$,
...
An adversarial validation exercise (2 rounds, 14 challenges, 10 partially
sustained, 4 rejected, none fatal) confirms the robustness of this conclusion
against aggressive technical scrutiny.  The Hubble tension is a $>7\sigma$
